...
<div class="container mt-5">
    <form class="form-control" action={{route('admin.settings.platforms.update', $platform)}} method="POST">
        ...
        <div class="mb-3">
            ...
            <input class="form-control" type="text" name="name" id="name" required value="{{$platform->name}}">
        </div>
        <div class="mb-3">
            <label class="form-control-label mb-2" for="description">Description</label>
            <textarea class="form-control" name="description" id="description" rows="10" required >value="{{$platform->description}}"</textarea>
        </div>
        <div class="mb-3">
            <label class="form-control-label mb-2" for="color">Color</label>
            <input class="form-control form-control-color w-25" type="color" name="color" id="color" value="{{$platform->color}}">
        </div>
