    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-around">
            ...
            <div class="form-check d-flex align-items-center">
                <input type="checkbox" id="platform-{{$platform->id}}" name="platforms[]" value="{{$platform->id}}" class="mx-2 form-check-input">
                <label for="platform-{{$platform->id}}"class="badge text-capitalize text-shadow " style="background-color: {{$platform->color}}">
